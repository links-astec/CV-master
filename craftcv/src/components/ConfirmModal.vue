      ...
      <div v-if="visible" class="confirm-backdrop" @click.self="resolve(false)">
        <div class="confirm-box">
          ...
          <div class="confirm-actions">
            ...
            <button class="confirm-ok" :class="okClass" @click="resolve(true)">{{ okLabel }}</button>
          </div>
        </div>
      </div>
    </Transition>
...
const iconClass = { danger: type.value === 'danger', warning: type.value === 'warning' }
const okClass   = { 'ok-danger': type.value === 'danger', 'ok-warning': type.value === 'warning' }
...
// Call this to show the modal — returns a Promise<boolean>
...
.ok-danger  { background: #dc2626; color: #fff; }
.ok-warning { background: #ca8a04; color: #fff; }
